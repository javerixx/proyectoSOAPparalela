...
public class escribir {
    ...
    ArrayList<Alumno> a1 = new ArrayList<Alumno>();
    ArrayList<Alumno> a2 = new ArrayList<Alumno>();
    ArrayList<Alumno> a3 = new ArrayList<Alumno>();
    ArrayList<Alumno> a4 = new ArrayList<Alumno>();
    ArrayList<Alumno> a5 = new ArrayList<Alumno>();
    ArrayList<Alumno> a6 = new ArrayList<Alumno>();
    ArrayList<Alumno> a7 = new ArrayList<Alumno>();
    ArrayList<Alumno> a8 = new ArrayList<Alumno>();
    ArrayList<Alumno> a9 = new ArrayList<Alumno>();
    ArrayList<Alumno> a10 = new ArrayList<Alumno>();
    ArrayList<Alumno> a11= new ArrayList<Alumno>();
    ArrayList<Alumno> a12 = new ArrayList<Alumno>();
    ArrayList<Alumno> a13 = new ArrayList<Alumno>();
    ArrayList<Alumno> a14 = new ArrayList<Alumno>();
    ArrayList<Alumno> a15 = new ArrayList<Alumno>();
    ArrayList<Alumno> a16 = new ArrayList<Alumno>();
    ArrayList<Alumno> a17 = new ArrayList<Alumno>();
    ArrayList<Alumno> a18 = new ArrayList<Alumno>();
    ArrayList<Alumno> a19 = new ArrayList<Alumno>();
    ArrayList<Alumno> a20 = new ArrayList<Alumno>();
    ArrayList<Alumno> a21 = new ArrayList<Alumno>();
    ArrayList<Alumno> a22 = new ArrayList<Alumno>();
    ArrayList<Alumno> a23 = new ArrayList<Alumno>();
    ArrayList<Alumno> a24 = new ArrayList<Alumno>();
    ArrayList<Alumno> a25 = new ArrayList<Alumno>();
    ArrayList<Alumno> a26 = new ArrayList<Alumno>();
    ArrayList<Alumno> a27 = new ArrayList<Alumno>();
    ArrayList<Alumno> a28 = new ArrayList<Alumno>();
    ...
    public void escribirXLSX() throws IOException {
        ...
        for(int i = 0; i<28; i++){
            ...
            fila.createCell(0).setCellValue("Rut"); // Primera columna: Ruts de los alumnos que están siendo matriculados
            fila.createCell(1).setCellValue("Ponderación"); // Segunda columna: Puntaje final de los alumnos que lograron conseguir en la PSU
            fila_n++;
            switch(i){
                case 0: // Administración Pública 
                    for(int j = 0; j < a1.size() ; j++){ // Recorro la lista de alumnos que está entrando a la carrera
                        ...
                        fila.createCell(0).setCellValue(x.getRut()); // Se escribe el rut del alumno
                        fila.createCell(1).setCellValue(x.getPonderacionesfinales().get(0).getPuntajefinal());
                ...
                case 1: 
                    for(int j = 0; j < a2.size() ; j++){
                        ...
                        fila.createCell(0).setCellValue(x.getRut());
                        fila.createCell(1).setCellValue(x.getPonderacionesfinales().get(0).getPuntajefinal());
                        fila_n++;
                    }
                    a2.clear();
        ...
        FileOutputStream fileout = new FileOutputStream("excelpruebaseba2.xlsx");
        book.write(fileout);
        fileout.close();
        book.close();
    }
    ...
    public  void leerdatos(String dato) throws IOException {
        ...
        String[] datos;
        String[] filas;
        ArrayList<Ponderacion> listaponderacion = new ArrayList<Ponderacion>();
        ...
        for (int j = 0; j < filas.length;j++){
            ...
            if((matematica + lenguaje)/2 > 450){ // Se verifica si se cumple puntaje minimo promedio para postular
                for(int a=0; a<28; a++){ // Se recorre las carreras
                    ...
                    // Se obtiene el puntaje final obtenido
